    ...
    return CommonPage(
      ...
      trailing: GestureDetector(
        ...
        child: Container(
          ...
          child: const Center(
            child: Text('导出', style: TextStyle(fontSize: 14, color: AppColors.accent, fontWeight: FontWeight.w500)),
          ),
        ),
      ),
      slivers: [
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const Text('结论', style: TextStyle(fontSize: 14, color: AppColors.ink3)),
          const SizedBox(height: 6),
          Text(report.conclusion,
              style: const TextStyle(fontSize: 15, color: AppColors.ink2, height: 1.6)),
